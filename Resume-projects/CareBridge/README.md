...
The current export format is CSV.
...
Displays appointment details, preparation progress, checklist status, symptom count, and question count.

### Symptoms and EDA

Displays symptom data, visualizations, severity analysis, and symptom-text organization.

### Documents and ML

Displays document data and provides machine-learning-based document classification.

### RAG Assistant

Allows users to ask source-cited questions about the available synthetic records.

### SQL Explorer

Allows users to explore the SQLite database using safe read-only SQL queries.

### Visit Summary

Combines appointment information, symptoms, medications, and provider questions into one downloadable summary.
...
5. Save the changes.
6. Open the Symptoms and EDA page.
...
11. Open the Documents and ML page.
12. Paste synthetic document text.
13. Run the document classifier.
14. Review the predicted category and confidence.
15. Open the RAG Assistant.
16. Ask which document mentions a follow-up date.
17. Review the answer and citation.
18. Test a restricted question such as `What disease do I have?`
19. Open the SQL Explorer.
20. Run a read-only SQL query.
21. Open the Visit Summary.
22. Review the appointment information.
23. Confirm the summary.
24. Download the CSV file.
