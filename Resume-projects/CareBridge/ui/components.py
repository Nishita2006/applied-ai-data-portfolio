...
def hero_copy() -> None:
    st.markdown('''<div class="mk-hero-copy"><div class="mk-badge"><i></i> Patient visit preparation</div><h1>Walk into your next appointment prepared.</h1><p>Bring symptoms, medications, records, questions, and preparation into one calm workspace—then create a brief you have reviewed.</p><div class="mk-actions"><a class="mk-primary" href="?start=1">Get Started →</a><a class="mk-secondary" href="#how-it-works">See How It Works</a></div><div class="mk-proof"><span>Works without an AI key</span><span>Evidence stays visible</span><span>No medical advice</span></div></div>''',unsafe_allow_html=True)
